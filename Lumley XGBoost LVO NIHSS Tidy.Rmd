---
title: "Lumley XGBoost LVO NIHSS"
...
StroBEABACUS_LVO=StroBEABACUSNS
...
#AUC in terms of all parameters 
  ...
  ggsave(plot=xgb_tg_auc_LVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Hyperparameters", filename="NIHSS Hyperparameters.png", height=8, width=16) 
...
Eval_plot=ggplot(Eval_mets_LVO, aes(iter, Error, group=Set))+
  ...
  theme(plot.title=element_text(face="bold", hjust=.5, size=8),
   ...
   ggsave(plot=Eval_plot, filename="Evaluation Log.png", path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots", height=5, width=8)
...
ggsave(plot=Res_Curve_LVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/ROC",
...
ggsave(plot=MergedTT_ROCS, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/ROC",
...
ggsave(plot=Pred_TLVO_Plot, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename="Whole Dataset Predictions for 100lh .png", height=8, width=15)
...
ggsave(plot=Pred_TLVO_Plot_Sens, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename="Whole Dataset Predictions for sens .png", height=8, width=15)
...
ggsave(plot=Pred_TLVO_spec, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename="Whole Dataset Predictions for spec .png", height=8, width=15)

#Facet the plots for WD
Preds_facet=gridExtra::grid.arrange(Pred_TLVO_Plot, Pred_TLVO_Plot_Spec, Pred_TLVO_Plot_Sens, nrow=2)
Preds_facet

ggsave(plot=Preds_facet, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename=" Facet Predictions.png", height=10, width=16)
...
ggsave(plot=Pred_WLVO_Plot, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename="CV Predictions for Best 100 lh.png", height=8, width=15)
...
ggsave(plot=Pred_WLVO_sens, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename="CV Predictions for sens 100 lh.png", height=8, width=15)
...
(threshold %s)", round(Spec_threshkf[1,1], 3)))+
     theme_light()+
       theme(plot.title=element_text(face="bold", hjust=.5, size=18),
           ...
           legend.text = element_text(face="bold", size=18))
Pred_WLVO_Plot_Spec
ggsave(plot=Pred_WLVO_spec, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename="CV Predictions for spec 100 lh.png", height=8, width=15)
...
ggsave(plot=Preds_facetkf, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Predictions", filename=" Facet CV Predictions.png", height=10, width=16)
...
###Mini confusion matrices#####
  ...
  XGB_Sens_CM_TX=Preds_Sens_maxkf%>%
    conf_mat(Truth_Classkf, Sens_Threshkf)
  XGB_Sens_CM_TX
  
  ##.spec kf
  XGB_Spec_CM_TF=Preds_Spec_maxkf%>%
    conf_mat(Truth_Classkf, Spec_Threshkf)
  XGB_Spec_CM_TF
  
  ## youden kf
  XGB_CM_Youdkf=Preds_Youdenkf%>%
    conf_mat(Truth_Classkf, Youden_Threshkf)
  XGB_CM_Youdkf
...
#Confusion table for Sensitivity
 ...
 #had to label the wrong way round to make it display correctly in the plot 
  ...
  Conf_Mat_FPR_Sens
   ...
   ggsave(plot=Conf_Mat_FPR_Sens, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Sensitivity .8 CM 100lh.png", height=5, width=6.5)
...
#Confusion table for Specificity
  ...
  ggsave(plot=Conf_Mat_FPR_Spec, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Specificity .8 CM.png", height=5, width=6)
...
ggsave(plot=Conf_Mat_Youden, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Youden CM.png", height=5, width=6)
  ...
  ggsave(plot=Thresh_fac, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Facet CM.png", height=10, width=14)
...
#####WD CMs
 ...
 Correct_sensWD=ifelse(CM_FPR_DF_SensWD$Truth_Class_LVO!=CM_FPR_DF_SensWD$Pred_Class, "Correct", "Incorrect")
  ...
  Conf_Mat_FPR_SensWD
   ...
   ggsave(plot=Conf_Mat_FPR_SensWD, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Sensitivity .8 CM WD 100lh.png", height=5, width=6.5)
  ...
  ggsave(plot=Conf_Mat_FPR_SpecWD, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Specificity .8 CM WD.png", height=5, width=6)
...
ggsave(plot=Conf_Mat_YoudenWD, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Youden CM WD.png", height=5, width=6)
...
ggsave(plot=Thresh_facWD, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/CMs", filename = "Facet CM WD.png", height=10, width=14)
```
...
ggsave(plot=LVO_AUC_PRCplt, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/ROC", filename="PRCWD.png") 
...
ggsave(plot=PRC_LVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/ROC", filename="PRC.png", height=7, width=7) 
...
sprintf("%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%,%s=%s%%", VIP_Num$Variable[1], round(VIP_Num$Importance[1]*100, 0), VIP_Num$Variable[2], round(VIP_Num$Importance[2]*100, 0), VIP_Num$Variable[3], round(VIP_Num$Importance[3]*100, 0), VIP_Num$Variable[4], round(VIP_Num$Importance[4]*100, 0), VIP_Num$Variable[5], round(VIP_Num$Importance[5]*100, 0), VIP_Num$Variable[6], round(VIP_Num$Importance[6]*100, 0), VIP_Num$Variable[7], round(VIP_Num$Importance[7]*100, 0), VIP_Num$Variable[8], round(VIP_Num$Importance[8]*100, 0), VIP_Num$Variable[9], round(VIP_Num$Importance[9]*100, 0), VIP_Num$Variable[10], round(VIP_Num$Importance[10]*100, 0), VIP_Num$Variable[11], round(VIP_Num$Importance[11]*100, 0), VIP_Num$Variable[12], round(VIP_Num$Importance[12]*100, 0), VIP_Num$Variable[13], round(VIP_Num$Importance[13]*100, 0))
 ...
 ###### Variable Importance Plots ########  
  ...
  ggsave(plot=VIP_col_allLVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/VIP", filename="Variable Importance Plot 100LH.png", height=8, width=11)  
...
ggsave(plot=FT_IntsLVOES, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Interactions", filename="Sum Gain Interactons 100lh.png", height=6, width=6)
...
ggsave(plot=Radar_plotLVOES, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/VIP", filename="VI Importance 100lh.png", height=8, width=8)
...
ggsave(plot=Radarint_plotLVOES, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/VIP", filename="VI Interactons.png", height=8, width=8)
```
...
ggsave(plot=Shap_Plot, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/SHAP", filename="LVO Shap Summary Plot 100lh.png", height=8, width=12)
...
ggsave(plot=Age_SPD, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Dependence Plots", filename="Age DP.png")
...
ggsave(plot=Shap_ints, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Interactions", filename="SHAP Interactons 100lh.png", height=14, width=17)
...
#Make the negative interactions positive + rescale *100 to be able to see the order
Shapintvalssub$valueS=Shapintvalssub$value*100
...
FacexAge=shap.plot.dependence(Shapvals, 
  ...
  geom_smooth(color="black")+
  scale_color_gradient(name="NIHSS Facial Weakness (No-Yes)",low="#2B1BFD", high="#FC1C21")+
  labs(title="Distribution of SHAP values for Age in Years 
       and their interaction with NIHSS Facial Weakness")+
  xlab("Age in Years")+
  ylab("SHAP value for Age in Years")+
  theme(plot.title = element_text(face="bold", size=10, hjust=0.5))
FacexAge
...
FacexSBP=shap.plot.dependence(Shapvals, 
                             x="Systolic Blood Pressure mmHg",
                             color_feature ="NIHSS Facial Weakness",
                             alpha=1,
                             smooth = FALSE
)+
  geom_smooth(color="black")+
...
Strong_grid=gridExtra::grid.arrange(ArmxSBP, FacexSBP,FacexBM, FacexAge,FacexTemp,TempxBM,BMxTemp, SBPxHR, nrow=2)
plot(Strong_grid)

ggsave(plot=Strong_grid, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Interactions", filename="Dependency Interactions Facet.png", height=12, width=22)
...
Face_Ice_example=plot(ice(LVO_fit, X=DX_LVO_Mx, predictor="NIHSS_Facial_Weakness", logodds=TRUE))
Face_Ice_example
...
ggsave(plot=LVO_shapforce, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Force Plots", filename="CLVO force.png", height=8, width=11)
...
ggsave(plot=ILVO_shapforce, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Force Plots", filename="ILVO force.png", height=8, width=11)
...
ggsave(plot=CNLVO_shapforce, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Force Plots", filename="CnLVO force.png", height=8, width=11)
...
ggsave(plot=INLVO_shapforce, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Force Plots", filename="INLVO force.png", height=8, width=11)
...
ggsave(plot=shapvizwfCLVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Waterfalls", filename="CLVO Individual Waterfall Plot.png", height=8, width=13)
...
ggsave(plot=shapvizwfILVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Waterfalls", filename="ILVO Individual Waterfall Plot.png", height=8, width=13)
...
ggsave(plot=shapvizwfINLVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Waterfalls", filename="INLVO Individual Waterfall Plot.png", height=8, width=13)
...
ggsave(plot=shapvizwfCNLVO, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Discrepancy/Waterfalls", filename="CNLVO Individual Waterfall Plot.png", height=8, width=13)
...
setwd("S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Trees")
...
ggsave(plot=LVO_Depth, path="S:/StroBE and ABACUS data for Hannah/Plots/NIHSS Plots/Trees", filename="LVO Tree Depth.png", height=3, width=5)
